...
class ingresopet(QMainWindow):
    ...
    def cont(self):
        ...
        if (ingresopet.s1 == ingresopet.s2 == 1 ) and (ingresopet.s5 == 0):
              self.hide()    
